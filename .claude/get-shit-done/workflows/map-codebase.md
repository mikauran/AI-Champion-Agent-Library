...
```bash
INIT=$(node "/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/bin/gsd-tools.cjs" init map-codebase)
...
```bash
node "/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: map existing codebase" --files .planning/codebase/*.md
```
