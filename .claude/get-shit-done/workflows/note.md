...
- **Global scope**: `/home/jhr/Projects/2026_AIC_Agent_Library/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/jhr/Projects/2026_AIC_Agent_Library/.claude/notes/`)
...
2. Glob `/home/jhr/Projects/2026_AIC_Agent_Library/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/jhr/Projects/2026_AIC_Agent_Library/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/jhr/Projects/2026_AIC_Agent_Library/.claude/notes/` — works in any directory
