...
```bash
PHASE_INFO=$(node "/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
...
```bash
PHASE_DIR=$(node "/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
