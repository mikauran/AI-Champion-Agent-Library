...
- Usage: Reference from command with `@/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/jhr/Projects/2026_AIC_Agent_Library/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/jhr/Projects/2026_AIC_Agent_Library/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
