...
Use template from `/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/home/jhr/Projects/2026_AIC_Agent_Library/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
